...
var require_library = __commonJS({
  "generated/prisma/runtime/library.js"(exports, module) {
    ...
    var As = ue((Bh, _e) => {
      "use strict";
      var Fi = __require("fs"), Mi = __require("path"), np = __require("os"), ip = __require("crypto"), op = Ps(), Ts = op.version, sp = /(?:^|^)\s*(?:export\s+)?([\w.-]+)(?:\s*=\s*?|:\s+?)(\s*'(?:\\'|[^'])*'|\s*"(?:\\"|[^"])*"|\s*`(?:\\`|[^`])*`|[^#\r\n]+)?\s*(?:#.*)?(?:$|$)/mg;
      function ap(e) {
        let r = {}, t = e.toString();
        t = t.replace(/\r\n?/mg, `
`);
...
Env vars from ${Y(l)} overwrite the ones from ${Y(a)}
    ...
    x(z12, "PrismaClientKnownRequestError");
...
`);
    ...
    function $r({ error: e, user_facing_error: r }, t, n) {
      return r.error_code ? new z12(um(r, n), { code: r.error_code, clientVersion: t, meta: r.meta, batchRequestIdx: r.batch_request_idx }) : new V(e, { clientVersion: t, batchRequestIdx: r.batch_request_idx });
    }
    function um(e, r) {
      let t = e.message;
...
`;
    ...
    async function Ft(e, r) {
      ...
      if (n.type === "QueryEngineError") throw new z12(n.body.message, { code: n.body.error_code, clientVersion: r });
    ...
    var Qr = class {
      ...
      async transaction(r, t, n) {
        ...
        if (xf(a)) {
          ...
          throw l ? l.error : new z12(a.message, { code: a.error_code, clientVersion: this.config.clientVersion, meta: a.meta });
    ...
    var ei = class {
      ...
      handleRequestError({ error: r, clientMethod: t, callsite: n, transaction: i, args: o, modelName: s, globalOmit: a }) {
        ...
        if (n && (l = Tn({ callsite: n, originalMethod: t, isPanic: r.isPanic, showColors: this.client._errorFormat === "pretty", message: l })), l = this.sanitizeMessage(l), r.code) {
          ...
          throw new z12(l, { code: r.code, clientVersion: this.client._clientVersion, meta: u, batchRequestIdx: r.batchRequestIdx });
        } else {
...
var require_prisma = __commonJS({
  "generated/prisma/index.js"(exports) {
    ...
    exports.Prisma.BarberCustomerScalarFieldEnum = {
      id: "id",
      user_barber_id: "user_barber_id",
    ...
    exports.Prisma.UserFavoriteHaircutScalarFieldEnum = {
      user_id: "user_id",
    ...
    exports.Prisma.ModelName = {
      User: "User",
      BarberCustomer: "BarberCustomer",
      BarberShop: "BarberShop",
      Haircut: "Haircut",
      UserFavoriteHaircut: "UserFavoriteHaircut",
      CheckIn: "CheckIn"
    };
    var config = {
      "generator": {
        ...
        "output": {
          "value": "/home/fredsouza/Documents/Verxus/www/barber-shop/generated/prisma",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "/home/fredsouza/Documents/Verxus/www/barber-shop/prisma/schema.prisma",
        "isCustomOutput": true
      },
      "relativeEnvPaths": {
        "rootEnvPath": null,
      ...
      "inlineSchemaHash": "9e146518266dd1423dbbebc6abfd35cc9bfa22489548bb3aebaaa7b1fbdf5a45",
      "copyEngine": true
    };
    var fs = __require("fs");
    ...
    config.runtimeDataModel = JSON.parse('{"models":{"User":{"dbName":"users","schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"uuid","args":[4]},"isGenerated":false,"isUpdatedAt":false},{"name":"role","kind":"enum","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"Role","nativeType":null,"default":"CUSTOMER","isGenerated":false,"isUpdatedAt":false},{"name":"name","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"email","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"password_hash","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"birth_date","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":["Date",[]],"isGenerated":false,"isUpdatedAt":false},{"name":"sex","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"phone","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"created_at","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"haircuts","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Haircut","nativeType":null,"relationName":"CustomerHaircuts","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"favorites_haircuts","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"UserFavoriteHaircut","nativeType":null,"relationName":"UserToUserFavoriteHaircut","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"customerCheckIns","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"CheckIn","nativeType":null,"relationName":"CustomerCheckIns","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"barberCheckIns","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"CheckIn","nativeType":null,"relationName":"BarberCheckIns","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"userLinksBarber","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"BarberCustomer","nativeType":null,"relationName":"UserAsEmployee","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"userLinksCustomer","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"BarberCustomer","nativeType":null,"relationName":"UserAsCustomer","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"BarberCustomer":{"dbName":"barber_customers","schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"uuid","args":[4]},"isGenerated":false,"isUpdatedAt":false},{"name":"user_barber_id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"user_customer_id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"barber","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"UserAsEmployee","relationFromFields":["user_barber_id"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"customer","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"UserAsCustomer","relationFromFields":["user_customer_id"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"BarberShop":{"dbName":"barber_shops","schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"uuid","args":[4]},"isGenerated":false,"isUpdatedAt":false},{"name":"title","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"phone","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"latitude","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Decimal","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"longitude","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Decimal","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"checkIns","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"CheckIn","nativeType":null,"relationName":"BarberShopToCheckIn","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"Haircut":{"dbName":"haircuts","schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"uuid","args":[4]},"isGenerated":false,"isUpdatedAt":false},{"name":"name","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"description","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"price","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Decimal","nativeType":["Decimal",["10","2"]],"isGenerated":false,"isUpdatedAt":false},{"name":"created_at","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"updated_at","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"customer","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"CustomerHaircuts","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"favoritedBy","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"UserFavoriteHaircut","nativeType":null,"relationName":"HaircutToUserFavoriteHaircut","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false},{"name":"checkIns","kind":"object","isList":true,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"CheckIn","nativeType":null,"relationName":"CheckInToHaircut","relationFromFields":[],"relationToFields":[],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"UserFavoriteHaircut":{"dbName":"user_favorite_haircuts","schema":null,"fields":[{"name":"user_id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"haircut_id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"user","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"UserToUserFavoriteHaircut","relationFromFields":["user_id"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"haircut","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Haircut","nativeType":null,"relationName":"HaircutToUserFavoriteHaircut","relationFromFields":["haircut_id"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":{"name":null,"fields":["user_id","haircut_id"]},"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false},"CheckIn":{"dbName":"check_ins","schema":null,"fields":[{"name":"id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":true,"isReadOnly":false,"hasDefaultValue":true,"type":"String","nativeType":null,"default":{"name":"uuid","args":[4]},"isGenerated":false,"isUpdatedAt":false},{"name":"created_at","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":true,"type":"DateTime","nativeType":null,"default":{"name":"now","args":[]},"isGenerated":false,"isUpdatedAt":false},{"name":"validated_at","kind":"scalar","isList":false,"isRequired":false,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"DateTime","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"barber_shop_id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"user_id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"barber_id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"haircut_id","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":true,"hasDefaultValue":false,"type":"String","nativeType":null,"isGenerated":false,"isUpdatedAt":false},{"name":"price","kind":"scalar","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Decimal","nativeType":["Decimal",["10","2"]],"isGenerated":false,"isUpdatedAt":false},{"name":"user","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"CustomerCheckIns","relationFromFields":["user_id"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"barber","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"User","nativeType":null,"relationName":"BarberCheckIns","relationFromFields":["barber_id"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"barbershop","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"BarberShop","nativeType":null,"relationName":"BarberShopToCheckIn","relationFromFields":["barber_shop_id"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false},{"name":"haircut","kind":"object","isList":false,"isRequired":true,"isUnique":false,"isId":false,"isReadOnly":false,"hasDefaultValue":false,"type":"Haircut","nativeType":null,"relationName":"CheckInToHaircut","relationFromFields":["haircut_id"],"relationToFields":["id"],"isGenerated":false,"isUpdatedAt":false}],"primaryKey":null,"uniqueFields":[],"uniqueIndexes":[],"isGenerated":false}},"enums":{"Role":{"values":[{"name":"ADMIN","dbName":null},{"name":"BARBER","dbName":null},{"name":"CUSTOMER","dbName":null}],"dbName":null}},"types":{}}');
...
// src/app.ts
import z11, { ZodError } from "zod";
import fastify from "fastify";
import fastifyJwt from "@fastify/jwt";
import fastifyCookie from "@fastify/cookie";

// src/use-cases/error/haircut-already-exists-error.ts
var HaircutAlreadyExistsError = class extends Error {
  constructor() {
...
// src/repositories/prisma/prisma-haircuts-repository.ts
var PrismaHaircutsRepository = class {
  async findById(id) {
...
// src/use-cases/create-haircut.ts
var CreateHaircutUseCase = class {
  constructor(haircutsRepository) {
    this.haircutsRepository = haircutsRepository;
  }
  async execute({
    name,
    description,
...
// src/use-cases/factories/make-create-haircut-use-case.ts
function MakeCreateHaircutUseCase() {
  return new CreateHaircutUseCase(new PrismaHaircutsRepository());
}

// src/http/controllers/haircuts/create.ts
import z2 from "zod";
async function create(request, reply) {
  const createHaircutBodySchema = z2.object({
    name: z2.string(),
...
// src/use-cases/update-haircut.ts
var UpdateHaircutUseCase = class {
  constructor(haircutRepository) {
...
// src/use-cases/factories/make-update-haircut-use-case.ts
function makeUpdateHaircutUseCase() {
  return new UpdateHaircutUseCase(new PrismaHaircutsRepository());
}

// src/http/controllers/haircuts/update.ts
import z3 from "zod";
async function update(request, reply) {
  const updateHaircutSchemaParams = z3.object({
    id: z3.uuid()
  });
  const updateHaircutSchemaBody = z3.object({
    name: z3.string().optional(),
    description: z3.string().optional(),
    price: z3.coerce.number().optional()
  });
...
// src/http/controllers/haircuts/routes.ts
async function haircutsRoutes(app2) {
  app2.post("/haircuts", create);
  app2.put("/haircuts/:id", update);
}

// src/repositories/prisma/prisma-barber-shops-repository.ts
var PrismaBarberShopsRepository = class {
  async findById(id) {
...
// src/use-cases/create-barber-shop.ts
var CreateBarberShopUseCase = class {
  constructor(barberShopsRepository) {
...
// src/use-cases/factories/make-create-barber-shop-use-case.ts
function makeCreateBarberShopUseCase() {
  return new CreateBarberShopUseCase(new PrismaBarberShopsRepository());
}

// src/http/controllers/barber-shops/create.ts
import z4 from "zod";
async function create2(request, reply) {
  const createBarberShopBodySchema = z4.object({
    title: z4.string(),
    phone: z4.string().nullable(),
    latitude: z4.number().refine((value) => {
      return Math.abs(value) <= 90;
    }),
    longitude: z4.number().refine((value) => {
      return Math.abs(value) <= 100;
    })
  });
  const { title, phone, latitude, longitude } = createBarberShopBodySchema.parse(request.body);
  try {
...
// src/http/controllers/barber-shops/routes.ts
async function barberShopsRoutes(app2) {
  app2.addHook("onRequest", verifyJWT);
  app2.post("/barberShops", { onRequest: [verifyUserRole("ADMIN")] }, create2);
}
...
var PrismaUsersRepository = class {
  ...
  async toggleFavoriteHaircut(userId, haircutId) {
...
// src/use-cases/error/invalid-user-role-error.ts
var InvalidUserRoleError = class extends Error {
  constructor() {
    super("Invalid user role!");
  }
};

// src/use-cases/error/duplicate-link-customer-to-barber-error.ts
var DuplicateLinkCustomerToBarberError = class extends Error {
  constructor() {
    super("Customer is already linked to the barber");
  }
};

// src/use-cases/link-customer-to-barber.ts
var LinkCustomerToBarberUseCase = class {
  constructor(usersRepository, barberCustomersRepository) {
    this.usersRepository = usersRepository;
    this.barberCustomersRepository = barberCustomersRepository;
  }
  async execute({
    userAsCustomerId,
    userAsBarberId
    ...
    const existingLink = await this.barberCustomersRepository.findByBarberAndCustomer(
      userAsBarberId,
      userAsCustomerId
    );
    if (existingLink) {
    ...
    const link2 = await this.barberCustomersRepository.create({
      userAsBarberId,
      userAsCustomerId
    });
    return {
      link: {
        userAsBarberId: link2.user_barber_id,
        userAsCustomerId: link2.user_customer_id
      }
    };
  }
};

// src/repositories/prisma/prisma-barber-customers-repository.ts
var PrismaBarberCustomersRepository = class {
  async create(data) {
    const link2 = await prisma.barberCustomer.create({
      data: {
  ...
  async findByBarberAndCustomer(barberId, customerId) {
    const link2 = await prisma.barberCustomer.findFirst({
      where: {
        user_barber_id: barberId,
...
// src/use-cases/factories/make-link-customer-tobarber-use-case.ts
function makeLinkCustomerToBarberUseCase() {
...
// src/http/controllers/baber-customers/link-barber.ts
import z5 from "zod";
async function link(request, reply) {
  const linkBodySchema = z5.object({
    userAsCustomerId: z5.uuid(),
    userAsBarberId: z5.uuid()
  });
  ...
  try {
    ...
    const { link: link2 } = await linkCustomerToBarberUseCase.execute({
      userAsCustomerId,
      userAsBarberId
    });
    return reply.status(201).send({ link: link2 });
  } catch (err) {
    if (err instanceof Error) {
...
// src/http/controllers/baber-customers/routes.ts
async function barberCustomersRoutes(app2) {
  app2.post("/barber-customers/link", link);
}
...
var PrismaCheckInsRepository = class {
  ...
  async counterByUserId(userCustomerId) {
  ...
  async totalSpentByUserCustomerId(userCustomerId) {
  ...
  async favoriteHaircutByUserCustomerId(userCustomerId) {
    const checkIns = await prisma.checkIn.findMany({
      where: {
        user_id: userCustomerId
      },
...
// src/use-cases/error/max-distance-error.ts
...
// src/use-cases/error/max-number-of-check-ins-error.ts
...
var CheckInUseCase = class {
  constructor(checkInsRepository, barberShopsRepository, haircutsRepository) {
...
async function create3(request, reply) {
  const createCheckInParamsSchema = z6.object({
    barberId: z6.uuid(),
    barberShopId: z6.uuid(),
    haircutId: z6.uuid()
  });
  const createCheckInBodySchema = z6.object({
    latitude: z6.number().refine((value) => {
      return Math.abs(value) <= 90;
    }),
    longitude: z6.number().refine((value) => {
      return Math.abs(value) <= 100;
    })
  });
...
// src/use-cases/error/late-check-in-validation-error.ts
...
var ValidateCheckInUsecase = class {
  ...
  async execute({
    ...
    const distanceInMinutesFromCheckInCreation = dayjs2(/* @__PURE__ */ new Date()).diff(
      checkIn.created_at,
      "minutes"
    );
...
function makeValidationCheckInUseCase() {
...
async function validate(request, reply) {
  const validateCheckInParamsSchema = z7.object({
    checkInId: z7.uuid()
  });
...
// src/use-cases/get-customer-metrics.ts
var GetCustomerMtricsUseCase = class {
  constructor(checkInsrepository) {
    this.checkInsrepository = checkInsrepository;
  }
  async execute({
    ...
    const checkInsCount = await this.checkInsrepository.counterByUserId(userCustomerId);
    const totalSpent = await this.checkInsrepository.totalSpentByUserCustomerId(userCustomerId);
    const favoriteHaircut = await this.checkInsrepository.favoriteHaircutByUserCustomerId(
      userCustomerId
    );
...
// src/use-cases/factories/make-get-user-customer-metrics-use-case.ts
function makeGetUserCustomerMetricsUseCase() {
...
async function metrics(request, reply) {
  ...
  const { checkInsCount, totalSpent, favoriteHaircut } = await getCustomerMetricsUseCase.execute({
...
// src/use-cases/choose-favorite-haircut.ts
var ChooseFavoriteHaircutUseCase = class {
  constructor(usersRepository, haircutsRepository) {
    this.usersRepository = usersRepository;
    this.haircutsRepository = haircutsRepository;
  }
  async execute({
...
// src/use-cases/factories/make-choose-favorite-haircut-use-case.ts
function makeChooseFavoriteHaircutUseCase() {
...
// src/http/controllers/users/choose-haircut.ts
import z8 from "zod";
async function choose(request, reply) {
  const createUserParamsSchema = z8.object({
    haircutId: z8.uuid()
  });
  ...
  const { user, haircut, favorited } = await chooseFavoriteHaircutUseCase.execute({
    userId: request.user.sub,
    haircutId
  });
  return reply.status(200).send({
...
// src/use-cases/error/invalid-credentials-error.ts
...
async function authenticate(request, reply) {
  const authenticateBodySchema = z9.object({
    email: z9.email(),
...
// src/use-cases/error/user-already-exists-error.ts
...
// src/http/controllers/users/schemas/register.schema.ts
import z10 from "zod";
var registerBodySchema = z10.object({
  name: z10.string(),
  email: z10.email(),
  password: z10.string().min(6),
  phone: z10.string().optional(),
  sex: z10.string(),
  birth_date: z10.preprocess(
    (val) => {
    ...
    z10.date().refine((date) => !isNaN(date.getTime()), {
      message: "Formato inv\xE1lido, esperado YYYY-MM-DD"
    })
  )
});
var registerResponseSchema = z10.object({
  201: z10.null().describe("User Created")
});
var errorResponseSchema = z10.object({
  message: z10.string().describe('Detalhe do erro, ex: "User with same email already exists."')
});
...
// src/http/controllers/users/docs/register.route.ts
var registerRoute = {
  method: "POST",
  url: "/users",
  schema: {
    ...
    response: {
      ...
      409: errorResponseSchema.describe("User alredy exists!")
    }
  },
  handler: register
};
...
async function setupSwagger(app2) {
...
await app.register(setupSwagger);
app.setErrorHandler((error, _, reply) => {
  if (error instanceof ZodError) {
    return reply.status(400).send({ message: "Validation error", issues: z11.treeifyError(error) });
  }
...
async function main() {
  try {
    ...
    console.log(`\u{1F4D6} Documenta\xE7\xE3o Swagger em http://localhost:${env.PORT}/docs`);
  } catch (err) {
    app.log.error(err);
    process.exit(1);
  }
